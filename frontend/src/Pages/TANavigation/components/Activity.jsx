// The Activity component visualizes a learner's journey through a timeline of activities. It fetches and displays activities,
// highlighting resources and contributions. Clicking an activity may open a ViewEditContribution component. It also tracks 
// and visualizes the learner's progression path based on clicked resources
...
import ViewEditContribution from "../../TeacherNavigation/components/ViewEditContribution";
    ...
    useEffect(() => {
        ...
        if (enrolledLearnerIDs.length > 0) {
            ...
            if (!currentLearner || currentLearner.enroll_id !== selectedLearner.enroll_id) {
                ...
                console.log("Set the current Learner")
            }
        }
