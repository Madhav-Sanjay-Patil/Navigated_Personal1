// The AddResource component provides a modal form for TAs to add new learning resources. It allows specifying the resource name, 
// topic, and type (YouTube link or PDF file), with input validation. Upon submission, it sends the data to the server 
// and triggers a reload of resources on success.
